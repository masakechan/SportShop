<!-- kiểm tra tổng chỉ phí trước khi thanh toán -->
<?php ob_start();
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        ...
                        <a href="index.php" class="primary-btn cart-btn cart-btn-right"><span class="icon_loading"></span>
                            Quay lại</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="shoping__continue">
                        <div class="shoping__discount">
                            <h5>Mã khuyến mãi</h5>
                            <form action="" method="post">
                                <input type="text" name="codediscount" placeholder=" Coupon code">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="shoping__checkout">
                        ...
                        <?php 
                            ...
                            if($qtt!='0'){
                         ?>
                        <a href="checkout.php" class="primary-btn">Tiếp tục thanh toán</a> <!-- tiếp tục thanh toán -->
                        <?php 
                        }else{
