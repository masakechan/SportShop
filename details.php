            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <button type="submit" class="site-btn" name="submit">Thêm vào giỏ</button>
                        
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                        <ul>
                            <li><b>Sản phẩm</b> <span>Vẫn còn</span></li>
                            <li><b>Shipping</b> <span>từ 1 - 3 ngày. <samp>Free pickup today</samp></span></li>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab"
                                    aria-selected="false">Reviews <span>(1.100)</span></a>
                            </li>
                        </ul>
