                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="checkout__input">
                                    <p>Note<span>*</span></p>
                                    <input type="text" name="ghichu" placeholder="thêm ghi chú">
                                </div>
                            </div>
                        ...
                        <div class="checkout__order">
                            ...
                            <ul>
                                ...
                                <li>  <?php
                                    ...
                                    echo $fm->textShorten($result['productName'],25); //hiển thị tên sản phẩm 
                                    echo " X".$result['quantity']; // Hiển thị số lượng sản phẩm
                                    ?>  <span><?php echo "$".$fm->format_currency($result['price'])?> </span> <!-- tính tổng cộng -->
                                    <span></span>
                                </li>
                                ...
                                <div class="checkout__order__subtotal">Subtotal <span><?php //để hiển thị tổng cộng của đơn hàng.
                                ...
                                <input type="submit" name="submit_buy"  value="Thanh toán" style="margin-left: 70px; font-size: 30px;  padding: 0 10px;background:#7fad39; color: white; ">
